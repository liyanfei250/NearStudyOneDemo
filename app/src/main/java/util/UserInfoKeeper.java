...
public class UserInfoKeeper {
    ...
    public static User getCurrentUser() {
        SharedPreferences sp = AbsSuperApplication.getContext().getSharedPreferences(
    ...
    public static String getToken() {
        ...
        String token = "";
        if (currentUser != null && currentUser.getUserinfos().getUserId() != null) {
            token = currentUser.getUserinfos().getUserId();
        }
        return token;
    }
